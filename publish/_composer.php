<?php
/**
 * Web Composer В© 2023 by Burak Boz is licensed under Attribution 4.0 International.
...
class WebComposer
{
    ...
    {
        $pattern = '(?xi)\b((?:https?://|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}/)(?:[^\s()<>]+|\(([^\s()<>]+|(\([^\s()<>]+\)))*\))+(?:\(([^\s()<>]+|(\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:\'".,<>?В«В»вЂњвЂќвЂ˜вЂ™]))';
    ...
    public static function header()
    {
        echo <<<HTML
<!-- 
Web Composer В© 2023 by Burak Boz is licensed under Attribution 4.0 International. To view a copy of this license, visit http://creativecommons.org/licenses/by/4.0/
-->
<!doctype html>
<html lang="en">
<head>
